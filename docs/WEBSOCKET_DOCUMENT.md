...
所有 WebSocket 连接需要在 CONNECT 帧中携带 Authorization 头：
...
| [WebSocketAuthChannelInterceptor.java](../src/main/java/com/chat/room/security/WebSocketAuthChannelInterceptor.java) | 认证拦截器 |
